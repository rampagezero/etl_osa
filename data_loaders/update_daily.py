...
def load_from_google_sheet(*args, **kwargs):
    ...
    header_rows = 1
    sheet_url = 'https://docs.google.com/spreadsheets/d/1keKW8fbYaX9CNI3oct1ON4mIz0wQEuxG0wedHUK1skw/edit?gid=1019663296#gid=1019663296'

    return GoogleSheets.with_config(ConfigFileLoader(config_path, config_profile)).load(
        sheet_url=sheet_url,
        header_rows=header_rows,
        worksheet_name='Update Daily'
    )
